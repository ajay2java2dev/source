...
@Embeddable
public class SubAcctSplanInactivePK implements Serializable {
	...
	public SubAcctSplanInactivePK() {}

	public SubAcctSplanInactivePK(Long splanIdNo, Long custIdNo, Long acctNo){
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SubAcctSplanInactivePK)) {
			return false;
		}
		SubAcctSplanInactivePK castOther = (SubAcctSplanInactivePK)other;

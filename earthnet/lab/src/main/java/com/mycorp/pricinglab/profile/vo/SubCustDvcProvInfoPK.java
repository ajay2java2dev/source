...
@Embeddable
public class SubCustDvcProvInfoPK implements Serializable {
	...
	public SubCustDvcProvInfoPK() {}

	public SubCustDvcProvInfoPK(Long custIdNo, Long acctNo, String mdn){
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SubCustDvcProvInfoPK)) {
			return false;
		}
		SubCustDvcProvInfoPK castOther = (SubCustDvcProvInfoPK)other;

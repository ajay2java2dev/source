...
public class SubXltBlRbmBak implements Serializable {
	...
	public Long rbmSequenceId;

	public Long getRbmSequenceId() {
		return rbmSequenceId;
}
	public void setRbmSequenceId(Long rbmSequenceId) {

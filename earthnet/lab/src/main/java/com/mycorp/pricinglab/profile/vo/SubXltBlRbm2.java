...
public class SubXltBlRbm2 implements Serializable {
	...
	@Column(name="BL_ID_VALUE2")
	public Long blIdValue2;

	public Long getBlIdValue2() {
		return blIdValue2;
}
	public void setBlIdValue2(Long blIdValue2) {
		this.blIdValue2 = blIdValue2;
	}

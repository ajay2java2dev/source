...
@Entity
@Table(name="SUB_SF_MDN_DELROWS")
@IdClass(SubSfMdnDelrowsPk.class)
public class SubSfMdnDelrows implements Serializable {
	...
	@Column(name="UBSR_TMSTAMP", nullable = true)
	...
	@Column(name="DELETE_IND",nullable = true)
	...
	@Column(name="RBM_POP_IND", nullable = true)
	...
	@Column(name="BILLING_RECON_TSTZ",nullable = true)
	...
	@Column(name="RATING_RECON_TSTZ",nullable = true)

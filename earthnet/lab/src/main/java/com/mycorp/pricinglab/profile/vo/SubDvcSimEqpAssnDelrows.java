...
public class SubDvcSimEqpAssnDelrows implements Serializable {
	...
	public String deviceAssnEffDt;

	public String getDeviceAssnEffDt() {
		return deviceAssnEffDt;
}
	public void setDeviceAssnEffDt(String deviceAssnEffDt) {

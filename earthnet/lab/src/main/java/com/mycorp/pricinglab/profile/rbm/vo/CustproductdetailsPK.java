...
@Embeddable
public class CustproductdetailsPK implements Serializable {
	...
	public CustproductdetailsPK() {}

	public CustproductdetailsPK(Timestamp startDat, String customerRef, Long productSeq, Long domainId){
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof CustproductdetailsPK)) {
			return false;
		}
		CustproductdetailsPK castOther = (CustproductdetailsPK)other;

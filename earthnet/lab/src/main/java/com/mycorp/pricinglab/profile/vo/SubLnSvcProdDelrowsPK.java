...
@Embeddable
public class SubLnSvcProdDelrowsPK implements Serializable {
	...
	public SubLnSvcProdDelrowsPK() {}

	public SubLnSvcProdDelrowsPK(Long lnOfSvcIdNoP1, Long lnOfSvcIdNoP2, Long svcProdId, Long lnSvcProdUniqueId){
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SubLnSvcProdDelrowsPK)) {
			return false;
		}
		SubLnSvcProdDelrowsPK castOther = (SubLnSvcProdDelrowsPK)other;
